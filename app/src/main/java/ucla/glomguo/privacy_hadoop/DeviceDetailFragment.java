...
import ucla.glomguo.privacy_hadoop.DeviceListFragment.DeviceActionListener;
        ...
        mContentView.findViewById(R.id.btn_disconnect).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //        LinearLayout.LayoutParams linearParams = (LinearLayout.LayoutParams)getActivity().findViewById(R.id.frag_detail).getLayoutParams();
                        //        linearParams.height = 500;
                        //        getActivity().findViewById(R.id.frag_detail).setLayoutParams(linearParams);
...
//        };
        ...
        if (info.groupFormed) {
            ...
            //Dynamic Layout, Invisible

            LinearLayout.LayoutParams linearParams = (LinearLayout.LayoutParams)getActivity().findViewById(R.id.frag_detail).getLayoutParams();
            linearParams.height = 500;
            getActivity().findViewById(R.id.frag_detail).setLayoutParams(linearParams);
            getActivity().findViewById(R.id.frag_list).setVisibility(View.GONE);
        }
